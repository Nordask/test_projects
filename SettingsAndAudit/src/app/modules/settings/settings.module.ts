...
import {AddModalComponent} from '@modules/settings/pages/add-modal/add-modal.component';
import {UpdateModalComponent} from '@modules/settings/pages/update-modal/update-modal.component';
